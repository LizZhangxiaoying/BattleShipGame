...
class ShipTest{
    ...
    void shootAt() {
        ...
        assertFalse(destroyer.shootAt(4,5));
        assertTrue(destroyer.shootAt(5,5));
        assertTrue(destroyer.shootAt(6,5));
        assertFalse(cruiser.shootAt(4,5));
    ...
    void okToPlaceShipAt() {
        ...
        destroyer.placeShipAt(0,1,false,ocean);
        assertEquals("destroyer", ocean.getShipArray()[0][1].getShipType());
        assertEquals("destroyer", ocean.getShipArray()[1][1].getShipType());
        assertEquals("emptySea", ocean.getShipArray()[2][1].getShipType());
        assertEquals("emptySea", ocean.getShipArray()[3][1].getShipType());
